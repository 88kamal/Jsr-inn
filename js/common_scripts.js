...
!function(b, a) {
    ...
    function a(d, b) {
        b = b || {},
        Object.assign(this, a.options, b),
        this.classes = Object.assign({}, a.options.classes, b.classes),
        this.elem = d,
    ...
    return a.prototype = {
        constructor: a,
        init: function() {
            return a.cutsTheMustard && !this.initialised && (this.addClass("initial"),
            this.initialised = !0,
            setTimeout(function(a) {
                a.scrollTracker = function(c, n, o) {
                    var p, a, b, q, e, d, f, g, h, i = function() {
                        ...
                        return b
                    }(), r = !1, j = (b = a = c) && b.document && 9 === b.document.nodeType ? (f = (d = (e = a).document).body,
                    g = d.documentElement,
                    {
                    ...
                    return c.addEventListener("scroll", l, m),
                    k(),
                    {
                        destroy: function() {
                            cancelAnimationFrame(p),
                            c.removeEventListener("scroll", l, m)
                        }
                    }
                }(a.scroller, {
                    offset: a.offset,
        ...
        update: function(a) {
            !a.isOutOfBounds && !0 !== this.frozen && (a.top ? this.top() : this.notTop(),
            a.bottom ? this.bottom() : this.notBottom(),
            this.shouldUnpin(a) ? this.unpin() : this.shouldPin(a) && this.pin())
        }
    },
    a.options = {
        tolerance: {
    ...
    $ && ($.fn.headroom = function(a) {
        return this.each(function() {
            var c = $(this)
              , b = c.data("headroom")
              , d = "object" == typeof a && a;
            d = $.extend(!0, {}, Headroom.options, d),
            b || ((b = new Headroom(this,d)).init(),
            c.data("headroom", b)),
            "string" == typeof a && (b[a](),
            "destroy" === a && c.removeData("headroom"))
        })
    }
    ,
   ...
   */
    ...
    class u {
        constructor(e, t) {
            ...
            void 0 !== i.options.showContols && (i.options.showControls = i.options.showContols,
        ...
        play(e) {
            ...
            i.YT.PlayerState.PLAYING !== t.player.getPlayerState() && t.player.playVideo()),
        ...
        pause() {
            let e = this;
            e.player && ("youtube" === e.type && e.player.pauseVideo && i.YT.PlayerState.PLAYING === e.player.getPlayerState() && e.player.pauseVideo(),
        ...
        getVideo(e) {
            ...
            t.onAPIready(()=>{
                let o;
                if (t.$video || ((o = document.createElement("div")).style.display = "none"),
                "youtube" === t.type) {
                    t.playerOptions = {
                    ...
                    t.playerOptions.events = {
                        ...
                        onStateChange(e) {
                            ...
                            a || e.data !== i.YT.PlayerState.PLAYING || (a = 1,
                            t.fire("started", e)),
                            ...
                            e.data === i.YT.PlayerState.PLAYING ? l = setInterval(()=>{
                                t.fire("timeupdate", e),
                ...
                if ("vimeo" === t.type) {
                    ...
                    t.options.showControls || (t.playerOptions.badge = 0,
        ...
        onAPIready(e) {
            ...
            "vimeo" === this.type) {
                if (void 0 !== i.Vimeo || n)
                    ...
                    n = 1;
                    let t = setInterval(()=>{
                        void 0 !== i.Vimeo && (clearInterval(t),
                        d.resolve("done"),
                        e())
                    }
                    , 20)
        ...
        t.prototype.coverImage = function() {
            ...
            if (e && this.video && t && ("IFRAME" === t || "VIDEO" === t)) {
                let i = e.image.height
                  ...
                  , r = e.image.marginTop;
                e.container.width > a && (i = (a = e.container.width) * this.image.height / this.image.width,
                l = 0,
    ...
    function o(t=i.jarallax) {
        ...
        ["initImg", "canInitParallax", "init", "destroy", "coverImage", "isVisible", "onScroll", "onResize"].forEach(t=>{
            ...
            e.prototype[t] = function(...e) {
                let o = this;
                if ("initImg" === t && null !== o.$item.getAttribute("data-jarallax-element") && (o.options.type = "element",
...
!function(t, e) {
    ...
    var Ut, Nt, qt = function _addPropTween(t, e, i, n, a, o, u, h, l, f) {
        ...
        var r, i, n, a, s, o, u, h, l, f, c, d, p, _ = t.vars, m = _.ease, g = _.startAt, v = _.immediateRender, y = _.lazy, T = _.onUpdate, b = _.onUpdateParams, x = _.callbackScope, M = _.runBackwards, O = _.yoyoEase, k = _.keyframes, P = _.autoRevert, C = t._dur, S = t._startAt, A = t._targets, D = t.parent, z = D && "nested" === D.data ? D.parent._targets : A, R = "auto" === t._overwrite && !F, E = t.timeline;
        if (!E || k && m || (m = "none"),
        t._ease = Lt(m, U.ease),
    ...
    $t.version = Qt.version = Ce.version = "3.11.0",
    o = 1,
    x() && Rt();
    function sd(t, e) {
    ...
    var Se, Ae, De, ze, Re, Ee, Fe, Ie, Be = Et.Power0, Le = Et.Power1, Xe = Et.Power2, Ye = Et.Power3, Ve = Et.Power4, Qe = Et.Linear, Ue = Et.Quad, Ne = Et.Cubic, qe = Et.Quart, je = Et.Quint, Ge = Et.Strong, Je = Et.Elastic, He = Et.Back, $e = Et.SteppedEase, We = Et.Bounce, Ze = Et.Sine, Ke = Et.Expo, tr = Et.Circ, er = {}, rr = 180 / Math.PI, ir = Math.PI / 180, nr = Math.atan2, ar = /([A-Z])/g, sr = /(left|right|width|margin|padding|x)/i, or = /[\s,\(]\S/, ur = {
        ...
        m = he(t, r.svg),
        r.svg && (k = (!r.uncache || "0px 0px" === X) && !e && t.getAttribute("data-svg-origin"),
...
!function(e, t) {
    ...
    var we, _e, ke, Me, Ae, Ee, Ce, Ie, Be, t, ze, De, i = 1, Re = [], k = [], He = [], Fe = Date.now, o = function _bridge(e, t) {
        return t
    ...
    var P = (Observer.prototype.init = function init(e) {
        ...
        var ee, te, re, ne, ie, oe, ae, se = this, le = 0, ce = 0, ue = J(n, je), fe = J(n, Je), de = ue(), pe = fe(), ge = ~t.indexOf("touch") && !~t.indexOf("pointer") && "pointerdown" === De[0], he = z(n), be = n.ownerDocument || Me, ve = [0, 0, 0], me = [0, 0, 0], ye = 0, xe = se.onPress = function(e) {
        ...
        se.enable = function(e) {
            ...
            (0 <= t.indexOf("touch") && Ce || 0 <= t.indexOf("pointer")) && (A(n, De[0], xe, s, q),
            A(be, De[2], Se),
            A(be, De[3], Se),
            $ && A(n, "click", Ke, !1, !0),
            G && A(n, "click", $e),
    ...
    function bc(l, e) {
        function Bj(e, t, r, n, i) {
            ...
            (t.modifiers = s)[d] = function(e) {
                ...
                Bj.tween = 0) : e = r + n * o.ratio + i * o.ratio * o.ratio,
                u = c,
                c = Math.round(e)
            }
            ,
    ...
    var Ge, a, qe, et, tt, rt, s, l, nt, it, ot, c, at, st, u, lt, f, d, p, ct, ut, g, h, b, v, m, C, ft, dt, x, pt, gt, ht = 1, bt = Date.now, w = bt(), vt = 0, mt = 0, yt = Math.abs, S = "right", _ = "bottom", xt = "width", wt = "height", St = "Right", _t = "Left", Tt = "Top", kt = "Bottom", Pt = "padding", Mt = "margin", At = "Width", T = "Height", Et = "px", Ct = function _getBounds(e, t) {
        ...
        i[r.p] = t + "px",
        Ge.set(e, i)
    }, Bt = [], zt = {}, Y = {}, R = [], H = function _dispatch(e) {
        ...
        if (!vt || e) {
            ...
            mb(te, "scrollEnd", Eb)
    }, G = 0, Dt = 1, U = function _updateAll() {
        if (!pt) {
            te.isUpdating = !0,
            gt && gt.update(0);
            var e = Bt.length
            ...
            if (Dt = n < G ? -1 : 1,
            G = n,
            r && (vt && !st && 200 < t - vt && (vt = 0,
            H("scrollEnd")),
            ot = w,
            w = t),
            Dt < 0) {
                for (lt = e; 0 < lt--; )
                    Bt[lt] && Bt[lt].update(0, r);
                Dt = 1
            } else
                for (lt = 0; lt < e; lt++)
                    Bt[lt] && Bt[lt].update(0, r);
        ...
        x = 0
    }, $ = ["left", "top", _, S, Mt + kt, Mt + St, Mt + Tt, Mt + _t, "display", "flexShrink", "float", "zIndex", "gridColumnStart", "gridColumnEnd", "gridRowStart", "gridRowEnd", "gridArea", "justifySelf", "alignSelf", "placeSelf", "order"], Q = $.concat([xt, wt, "boxSizing", "max" + At, "max" + T, "position", Mt, Pt, Pt + Tt, Pt + St, Pt + kt, Pt + _t]), Z = /([A-Z])/g, Lt = function _setState(e) {
        if (e) {
        ...
        mt) {
            ...
            G = Ge.delayedCall(ce.delay || i / 2 || .1, function() {
                var e = Ae()
                  , t = bt() - Me < 500
                  , r = k.tween;
                if (!(t || Math.abs(Se.getVelocity()) < 10) || r || st || Pe === e)
            ...
            ie && (!1 === oe || oe === Mt || (oe = !(!oe && "flex" === cb(ie.parentNode).display) && Pt),
            Se.pin = ie,
            ...
            Se.revert = function(e, t) {
                ...
                var r = !1 !== e || !Se.enabled
                  , n = at;
                r !== Se.isReverted && (r && (!Se.scroll.rec && at && pt && (Se.scroll.rec = Ae()),
                U = Math.max(Ae(), Se.scroll.rec || 0),
                K = Se.progress,
                q = T && T.progress()),
                C && [C, O, B, z].forEach(function(e) {
                ...
                if (!at && Se.enabled || t)
                    if (ie && e && vt)
                        ...
                        for (var r, n, i, o, a, s, l, c, u, f, d = Te(), p = ke(), g = fe ? fe.duration() : Ga(be, ge), h = 0, b = 0, v = _.end, m = _.endTrigger || ne, y = _.start || (0 !== _.start && ne ? ie ? "0 0" : "0 100%" : 0), x = Se.pinnedContainer = _.pinnedContainer && I(_.pinnedContainer), w = ne && Math.max(0, Bt.indexOf(Se)) || 0, S = w; S--; )
                            ...
                            S--);
                        for (Ja(y) && (y = y(Se)),
                        A = $b(y, ne, d, ge, Ae(), C, B, Se, p, we, me, g, fe) || (ie ? -.001 : 0),
                        Ja(v) && (v = v(Se)),
                        Ia(v) && !v.indexOf("+=") && (~v.indexOf(" ") ? v = (Ia(y) ? y.split(" ")[0] : "") + v : (h = sb(v.substr(2), d),
                        v = Ia(y) ? y : A + h,
                        m = ne)),
                        E = Math.max(A, $b(v || (m ? "100% 0" : g), m, d, ge, Ae() + h, O, z, Se, p, we, me, g, fe)) || -.001,
                        D = E - A || (A -= .01) && .001,
                        h = 0,
                        S = w; S--; )
                            (l = (s = Bt[S]).pin) && s.start - s._pinPush < A && !fe && 0 < s.end && (r = s.end - s.start,
                        ...
                        ie)
                            ...
                            n = Ct(ie, !0),
                            c = me && J(be, o ? je : Je)(),
                            oe && ((W = [oe + ge.os2, D + b + Et]).t = R,
                            (S = oe === Pt ? gb(ie, ge) + D + b : 0) && W.push(ge.d, S + Et),
                            Lt(W),
                            me && Ae(U)),
                            me && ((a = {
            ...
            Se.update = function(e, t, r) {
                if (!fe || r || e) {
                    var n, i, o, a, s, l, c, u = Se.scroll(), f = e ? 0 : (u - A) / D, d = f < 0 ? 0 : 1 < f ? 1 : f || 0, p = Se.progress;
                    if (t && (M = P,
                    P = fe ? Ae() : u,
                    ce && (j = S,
                    S = T && !he ? T.totalProgress() : d)),
                    se && !d && ie && !at && !ht && vt && A < u + (u - M) / (bt() - ot) * se && (d = 1e-4),
                    d !== p && Se.enabled) {
                        ...
                        V ? V.progress(1) : Ma(T, !d, 1))) : he && Q && !at && Q(Se)
                    }
                    if (w) {
            ...
            Se.enable(!1, !1),
            o && o(Se),
            T && T.add && !D ? Ge.delayedCall(.01, function() {
    ...
    te.batch = function(e, t) {
        ...
        for (r in t)
            i[r] = "on" === r.substr(0, 2) && Ja(t[r]) && "onRefreshInit" !== r ? io(0, t[r]) : t[r];
        return Ja(a) && (a = a(),
...
!function(t, a) {
    ...
    "function" == typeof define && define.amd ? define(["moment", "jquery"], function(t, e) {
        ...
        a(t, e)
    }) : "object" == typeof module && module.exports ? ((e = "undefined" != typeof window ? window.jQuery : void 0) || (e = require("jquery")).fn || (e.fn = {}),
    i = "undefined" != typeof window && void 0 !== window.moment ? window.moment : require("moment"),
    module.exports = a(i, e)) : t.daterangepicker = a(t.moment, t.jQuery)
    ...
    function i(t, e, a) {
        ...
        "string" == typeof (e = L.extend(this.element.data(), e)).template || e.template instanceof L || (e.template = '<div class="daterangepicker"><div class="ranges"></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn" type="button"></button><button class="applyBtn" disabled="disabled" type="button"></button> </div></div>'),
        this.parentEl = e.parentEl && L(e.parentEl).length ? L(e.parentEl) : L(this.parentEl),
        ...
        "string" == typeof e.locale.customRangeLabel && ((h = document.createElement("textarea")).innerHTML = e.locale.customRangeLabel,
        l = h.value,
        ...
        0 != this.locale.firstDay)
            for (var o = this.locale.firstDay; 0 < o; )
                ...
                o--;
        if (void 0 === e.startDate && void 0 === e.endDate && L(this.element).is(":text") && (r = i = null,
        2 == (t = (n = L(this.element).val()).split(this.locale.separator)).length ? (r = A(t[0], this.locale.format),
        i = A(t[1], this.locale.format)) : this.singleDatePicker && "" !== n && (r = A(n, this.locale.format),
        i = A(n, this.locale.format)),
        null !== r && null !== i && (this.setStartDate(r),
        this.setEndDate(i))),
        "object" == typeof e.ranges) {
            for (s in e.ranges) {
                r = "string" == typeof e.ranges[s][0] ? A(e.ranges[s][0], this.locale.format) : A(e.ranges[s][0]),
                i = "string" == typeof e.ranges[s][1] ? A(e.ranges[s][1], this.locale.format) : A(e.ranges[s][1]),
                this.minDate && r.isBefore(this.minDate) && (r = this.minDate.clone());
                var h, l, c = this.maxDate;
                this.maxSpan && c && r.clone().add(this.maxSpan).isAfter(c) && (c = r.clone().add(this.maxSpan)),
                c && i.isAfter(c) && (i = c.clone()),
                this.minDate && i.isBefore(this.minDate, this.timepicker ? "minute" : "day") || c && r.isAfter(c, this.timepicker ? "minute" : "day") || ((h = document.createElement("textarea")).innerHTML = s,
                l = h.value,
                this.ranges[l] = [r, i])
            }
            var d = "<ul>";
            ...
            this.showCustomRangeLabel && (d += '<li data-range-key="' + this.locale.customRangeLabel + '">' + this.locale.customRangeLabel + "</li>"),
            d += "</ul>",
        ...
        this.element.on("keydown.daterangepicker", L.proxy(this.toggle, this))),
        this.updateElement()
    }
    return i.prototype = {
        constructor: i,
        ...
        updateCalendars: function() {
            var t, e, a, i;
            this.timePicker && (this.endDate ? (e = parseInt(this.container.find(".left .hourselect").val(), 10),
            ...
            this.timePicker24Hour || ("PM" === (i = this.container.find(".left .ampmselect").val()) && e < 12 && (e += 12),
            "AM" === i && 12 === e && (e = 0))) : (e = parseInt(this.container.find(".right .hourselect").val(), 10),
            ...
            this.timePicker24Hour || ("PM" === (i = this.container.find(".right .ampmselect").val()) && e < 12 && (e += 12),
            "AM" === i && 12 === e && (e = 0))),
        ...
        renderCalendar: function(t) {
            ...
            a < l && (l -= 7),
            o == this.locale.firstDay && (l = a - 6);
            for (var m = A([i, c, l, 12, n, r]), d = 0, p = 0, f = 0; d < 42; d++,
            p++,
            m = A(m).add(24, "hour"))
                0 < d && p % 7 == 0 && (p = 0,
                f++),
                ...
                m.hour(12),
                this.minDate && e[f][p].format("YYYY-MM-DD") == this.minDate.format("YYYY-MM-DD") && e[f][p].isBefore(this.minDate) && "left" == t && (e[f][p] = this.minDate.clone()),
                this.maxDate && e[f][p].format("YYYY-MM-DD") == this.maxDate.format("YYYY-MM-DD") && e[f][p].isAfter(this.maxDate) && "right" == t && (e[f][p] = this.maxDate.clone());
            "left" == t ? this.leftCalendar.calendar = e : this.rightCalendar.calendar = e;
            var u = "left" == t ? this.minDate : this.startDate
              , D = this.maxDate
              , g = ("left" == t ? this.startDate : this.endDate,
            this.locale.direction,
            '<table class="table-condensed">');
            g += "<thead>",
            g += "<tr>",
            (this.showWeekNumbers || this.showISOWeekNumbers) && (g += "<th></th>"),
            u && !u.isBefore(e.firstDay) || this.linkedCalendars && "left" != t ? g += "<th></th>" : g += '<th class="prev available"><span></span></th>';
            c = this.locale.monthNames[e[1][1].month()] + e[1][1].format(" YYYY");
            if (this.showDropdowns) {
                for (var y = e[1][1].month(), k = e[1][1].year(), b = D && D.year() || this.maxYear, l = u && u.year() || this.minYear, C = k == l, v = k == b, Y = '<select class="monthselect">', w = 0; w < 12; w++)
                    (!C || u && w >= u.month()) && (!v || D && w <= D.month()) ? Y += "<option value='" + w + "'" + (w === y ? " selected='selected'" : "") + ">" + this.locale.monthNames[w] + "</option>" : Y += "<option value='" + w + "'" + (w === y ? " selected='selected'" : "") + " disabled='disabled'>" + this.locale.monthNames[w] + "</option>";
                Y += "</select>";
                for (var P = '<select class="yearselect">', x = l; x <= b; x++)
                    P += '<option value="' + x + '"' + (x === k ? ' selected="selected"' : "") + ">" + x + "</option>";
                c = Y + (P += "</select>")
            }
            g += '<th colspan="5" class="month">' + c + "</th>",
            D && !D.isAfter(e.lastDay) || this.linkedCalendars && "right" != t && !this.singleDatePicker ? g += "<th></th>" : g += '<th class="next available"><span></span></th>',
            g += "</tr>",
            g += "<tr>",
            (this.showWeekNumbers || this.showISOWeekNumbers) && (g += '<th class="week">' + this.locale.weekLabel + "</th>"),
            ...
            g += "</thead>",
            g += "<tbody>",
            null == this.endDate && this.maxSpan && (c = this.startDate.clone().add(this.maxSpan).endOf("day"),
            D && !c.isBefore(D) || (D = c));
            for (f = 0; f < 6; f++) {
                g += "<tr>",
                this.showWeekNumbers ? g += '<td class="week">' + e[f][0].week() + "</td>" : this.showISOWeekNumbers && (g += '<td class="week">' + e[f][0].isoWeek() + "</td>");
                for (p = 0; p < 7; p++) {
                    var M = [];
                    e[f][p].isSame(new Date, "day") && M.push("today"),
                    5 < e[f][p].isoWeekday() && M.push("weekend"),
                    e[f][p].month() != e[1][1].month() && M.push("off", "ends"),
                    this.minDate && e[f][p].isBefore(this.minDate, "day") && M.push("off", "disabled"),
                    D && e[f][p].isAfter(D, "day") && M.push("off", "disabled"),
                    this.isInvalidDate(e[f][p]) && M.push("off", "disabled"),
                    e[f][p].format("YYYY-MM-DD") == this.startDate.format("YYYY-MM-DD") && M.push("active", "start-date"),
                    null != this.endDate && e[f][p].format("YYYY-MM-DD") == this.endDate.format("YYYY-MM-DD") && M.push("active", "end-date"),
                    null != this.endDate && e[f][p] > this.startDate && e[f][p] < this.endDate && M.push("in-range");
                    ...
                    for (var S = "", B = !1, d = 0; d < M.length; d++)
                        ...
                        "disabled" == M[d] && (B = !0);
                    B || (S += "available"),
                    g += '<td class="' + S.replace(/^\s+|\s+$/g, "") + '" data-title="r' + f + "c" + p + '">' + e[f][p].date() + "</td>"
                }
                g += "</tr>"
            }
            g += "</tbody>",
            g += "</table>",
            this.container.find(".drp-calendar." + t + " .calendar-table").html(g)
        },
        renderTimePicker: function(t) {
            if ("right" != t || this.endDate) {
                var e, a, i, s = this.maxDate;
                !this.maxSpan || this.maxDate && !this.startDate.clone().add(this.maxSpan).isBefore(this.maxDate) || (s = this.startDate.clone().add(this.maxSpan)),
                "left" == t ? (a = this.startDate.clone(),
                i = this.minDate) : "right" == t && (a = this.endDate.clone(),
                i = this.startDate,
                "" != (n = this.container.find(".drp-calendar.right .calendar-time")).html() && (a.hour(isNaN(a.hour()) ? n.find(".hourselect option:selected").val() : a.hour()),
                ...
                this.timePicker24Hour || ("PM" === (d = n.find(".ampmselect option:selected").val()) && a.hour() < 12 && a.hour(a.hour() + 12),
                ...
                for (var n = this.timePicker24Hour ? 0 : 1, r = this.timePicker24Hour ? 23 : 12, o = n; o <= r; o++) {
                    ...
                    h != a.hour() || c ? e += c ? '<option value="' + o + '" disabled="disabled" class="disabled">' + o + "</option>" : '<option value="' + o + '">' + o + "</option>" : e += '<option value="' + o + '" selected="selected">' + o + "</option>"
                }
                e += "</select> ",
                ...
                for (var d, o = 0; o < 60; o += this.timePickerIncrement) {
                    ...
                    a.minute() != o || c ? e += c ? '<option value="' + o + '" disabled="disabled" class="disabled">' + m + "</option>" : '<option value="' + o + '">' + m + "</option>" : e += '<option value="' + o + '" selected="selected">' + m + "</option>"
                }
                if (e += "</select> ",
                this.timePickerSeconds) {
                    ...
                    for (o = 0; o < 60; o++) {
                        ...
                        i && l.isBefore(i) && (c = !0),
                        s && l.isAfter(s) && (c = !0),
                        a.second() != o || c ? e += c ? '<option value="' + o + '" disabled="disabled" class="disabled">' + m + "</option>" : '<option value="' + o + '">' + m + "</option>" : e += '<option value="' + o + '" selected="selected">' + m + "</option>"
                    }
                    e += "</select> "
                }
                this.timePicker24Hour || (e += '<select class="ampmselect">',
                n = d = "",
                i && a.clone().hour(12).minute(0).second(0).isBefore(i) && (d = ' disabled="disabled" class="disabled"'),
                s && a.clone().hour(0).minute(0).second(0).isAfter(s) && (n = ' disabled="disabled" class="disabled"'),
                12 <= a.hour() ? e += '<option value="AM"' + d + '>AM</option><option value="PM" selected="selected"' + n + ">PM</option>" : e += '<option value="AM" selected="selected"' + d + '>AM</option><option value="PM"' + n + ">PM</option>",
                e += "</select>"),
        ...
        move: function() {
            ...
            a) {
            case "auto":
                (t = this.element.offset().top + this.element.outerHeight() - e.top) + this.container.outerHeight() >= this.parentEl[0].scrollHeight && (t = this.element.offset().top - this.container.outerHeight() - e.top,
                a = "up");
                break;
            case "up":
            ...
            "left" == this.opens ? n + (i = i - this.element.offset().left - this.element.outerWidth()) > L(window).width() ? this.container.css({
                top: t,
                right: "auto",
                left: 9
            }) : this.container.css({
        ...
        show: function(t) {
            ...
            L(document).on("mousedown.daterangepicker", this._outsideClickProxy).on("touchend.daterangepicker", this._outsideClickProxy).on("click.daterangepicker", "[data-bs-toggle=dropdown]", this._outsideClickProxy).on("focusin.daterangepicker", this._outsideClickProxy),
            L(window).on("resize.daterangepicker", L.proxy(function(t) {
                this.move(t)
            }, this)),
        ...
        clickRange: function(t) {
            ...
            (this.chosenLabel = t) == this.locale.customRangeLabel ? this.showCalendars() : (t = this.ranges[t],
            this.startDate = t[0],
            this.endDate = t[1],
        ...
        clickPrev: function(t) {
            L(t.target).parents(".drp-calendar").hasClass("left") ? (this.leftCalendar.month.subtract(1, "month"),
            this.linkedCalendars && this.rightCalendar.month.subtract(1, "month")) : this.rightCalendar.month.subtract(1, "month"),
            this.updateCalendars()
        },
        clickNext: function(t) {
            L(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar.month.add(1, "month") : (this.rightCalendar.month.add(1, "month"),
            this.linkedCalendars && this.leftCalendar.month.add(1, "month")),
            this.updateCalendars()
        },
        hoverDate: function(t) {
            var e, a, s, n, r, o;
            L(t.target).hasClass("available") && (e = (a = L(t.target).attr("data-title")).substr(1, 1),
            a = a.substr(3, 1),
            s = (L(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar : this.rightCalendar).calendar[e][a],
            n = this.leftCalendar,
            r = this.rightCalendar,
            o = this.startDate,
            this.endDate || this.container.find(".drp-calendar tbody td").each(function(t, e) {
                var a, i;
                L(e).hasClass("week") || (a = (i = L(e).attr("data-title")).substr(1, 1),
                i = i.substr(3, 1),
                (i = (L(e).parents(".drp-calendar").hasClass("left") ? n : r).calendar[a][i]).isAfter(o) && i.isBefore(s) || i.isSame(s, "day") ? L(e).addClass("in-range") : L(e).removeClass("in-range"))
            }))
        },
        clickDate: function(t) {
            ...
            L(t.target).hasClass("available") && (e = (a = L(t.target).attr("data-title")).substr(1, 1),
            a = a.substr(3, 1),
            a = (L(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar : this.rightCalendar).calendar[e][a],
            this.endDate || a.isBefore(this.startDate, "day") ? (this.timePicker && (i = parseInt(this.container.find(".left .hourselect").val(), 10),
            this.timePicker24Hour || ("PM" === (s = this.container.find(".left .ampmselect").val()) && i < 12 && (i += 12),
            "AM" === s && 12 === i && (i = 0)),
            ...
            this.endDate = null,
            this.setStartDate(a.clone())) : !this.endDate && a.isBefore(this.startDate) ? this.setEndDate(this.startDate.clone()) : (this.timePicker && (i = parseInt(this.container.find(".right .hourselect").val(), 10),
            this.timePicker24Hour || ("PM" === (s = this.container.find(".right .ampmselect").val()) && i < 12 && (i += 12),
            "AM" === s && 12 === i && (i = 0)),
            ...
            r = this.timePickerSeconds ? parseInt(this.container.find(".right .secondselect").val(), 10) : 0,
            a = a.clone().hour(i).minute(n).second(r)),
        ...
        calculateChosenLabel: function() {
            ...
            e && (this.showCustomRangeLabel ? this.chosenLabel = this.container.find(".ranges li:last").addClass("active").attr("data-range-key") : this.chosenLabel = null,
            this.showCalendars())
        },
        ...
        monthOrYearChanged: function(t) {
            ...
            e || (t < this.startDate.year() || t == this.startDate.year() && a < this.startDate.month()) && (a = this.startDate.month(),
            t = this.startDate.year()),
            this.minDate && (t < this.minDate.year() || t == this.minDate.year() && a < this.minDate.month()) && (a = this.minDate.month(),
            t = this.minDate.year()),
            this.maxDate && (t > this.maxDate.year() || t == this.maxDate.year() && a > this.maxDate.month()) && (a = this.maxDate.month(),
            t = this.maxDate.year()),
            e ? (this.leftCalendar.month.month(a).year(t),
            this.linkedCalendars && (this.rightCalendar.month = this.leftCalendar.month.clone().add(1, "month"))) : (this.rightCalendar.month.month(a).year(t),
        ...
        timeChanged: function(t) {
            ...
            this.timePicker24Hour || ("PM" === (e = e.find(".ampmselect").val()) && i < 12 && (i += 12),
            "AM" === e && 12 === i && (i = 0)),
            a ? ((n = this.startDate.clone()).hour(i),
            n.minute(s),
            n.second(t),
            this.setStartDate(n),
            this.singleDatePicker ? this.endDate = this.startDate.clone() : this.endDate && this.endDate.format("YYYY-MM-DD") == n.format("YYYY-MM-DD") && this.endDate.isBefore(n) && this.setEndDate(n.clone())) : this.endDate && ((n = this.endDate.clone()).hour(i),
            n.minute(s),
            n.second(t),
            this.setEndDate(n)),
            this.updateCalendars(),
        ...
        elementChanged: function() {
            var t, e, a;
            this.element.is("input") && this.element.val().length && (a = e = null,
            2 === (t = this.element.val().split(this.locale.separator)).length && (e = A(t[0], this.locale.format),
            a = A(t[1], this.locale.format)),
            !this.singleDatePicker && null !== e && null !== a || (a = e = A(this.element.val(), this.locale.format)),
        ...
        updateElement: function() {
            var t;
            this.element.is("input") && this.autoUpdateInput && (t = this.startDate.format(this.locale.format),
...
!function(i) {
    i.fn.theiaStickySidebar = function(t) {
        function e(t, e) {
            return !0 === t.initialized || !(i("body").width() < t.minWidth) && (o(t, e),
            !0)
        }
        function o(t, e) {
            t.initialized = !0,
            ...
            e.each(function() {
                ...
                0 == r ? (n.stickySidebar.css("padding-bottom", 0),
                ...
                n.onScroll = function(n) {
                    if (n.stickySidebar.is(":visible"))
                        if (i("body").width() < n.options.minWidth)
                            e();
                        else if (n.options.disableOnResponsiveLayouts && n.sidebar.outerWidth("none" == n.sidebar.css("float")) + 50 > n.container.width())
                            e();
                        else {
                            var s = i(document).scrollTop()
                              , d = "static";
                            if (s >= n.sidebar.offset().top + (n.paddingTop - n.options.additionalMarginTop)) {
                                var r, c = n.paddingTop + t.additionalMarginTop, p = n.paddingBottom + n.marginBottom + t.additionalMarginBottom, b = n.sidebar.offset().top, l = n.sidebar.offset().top + o(n.container), f = 0 + t.additionalMarginTop;
                            ...
                            if ("fixed" == d) {
                                ...
                                k.transform = "translateY(" + (s + u - n.sidebar.offset().top - n.stickySidebarPaddingTop - n.stickySidebarPaddingBottom) + "px)",
                                k.top = "0px"),
                ...
                ,
                n.onScroll(n),
                i(document).on("scroll." + n.options.namespace, function(i) {
                    return function() {
                        i.onScroll(i)
                    }
                }(n)),
                i(window).on("resize." + n.options.namespace, function(i) {
                    return function() {
                        i.stickySidebar.css({
                            position: "static"
                        }),
...
!function(e, t) {
    ...
    return function(e) {
        ...
        function L(e, t, n, o) {
            ...
            this.adjustSize = function() {
                if ((c = r.maxSourceWidth / s) < r.maxSourceHeight)
                    return n < r.maxSourceWidth && (c = o),
                    a();
                c = o > r.maxSourceHeight ? r.maxSourceHeight : o,
                a()
            }
            ;
            var a = function() {
        ...
        function R(e, t) {
            ...
            return n.className = "".concat(r, "toolbar-button ").concat(a),
            n.title = t,
            e.appendChild(n),
            n
        }
